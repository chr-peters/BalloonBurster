...
public class TransitionScreen implements Screen{
	...
	public TransitionScreen(com.roterballon.balloonburster.BalloonBursterGame game, Screen start, Screen end){
		this.fadeTime = 0.4f;
		this.timePassed = 0f;
		this.start = start;
		this.end = end;
	...
	public void render(float delta) {
		if(fadeTime/2>timePassed){
			...
			renderer.rect(0, 0, com.roterballon.balloonburster.BalloonBursterGame.V_WIDTH, com.roterballon.balloonburster.BalloonBursterGame.V_HEIGHT);
			renderer.end();
